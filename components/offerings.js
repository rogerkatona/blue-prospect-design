    ...
    return (
        ...
        <section className="py-12 md:pb-12">
            <div className='font-bebasNeue text-6xl uppercase text-gray.700 flex flex-row  justify-center pb-6'>What we offer</div>
                <div className="flex md:flex-row flex-col max-w-7xl justify-center items-center mx-auto  p-6 md:space-y-0 space-y-12 md:space-x-6">
                    {filteredItem.map(filteredItem => (
                        <div key={filteredItem.id} className="flex flex-row justify-center items-center md:bg-tan.100 lg:w-2/3 md:p-12 w-full space-x-2 ">
                                ...
                                <div className="md:pl-4 w-full">
                                    ...
                                    <div className="text-xl">{filteredItem.description}</div>
                                    <ul className="text-left list-disc pl-4 text-sm ">
