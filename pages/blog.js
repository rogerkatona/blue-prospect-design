        ...
        <Layout home>
            ...
            <div className="min-h-screen">
                ...
                <div className="max-w-7xl mx-auto ">
                    ...
                    {allPostsData
                        .filter(featured => featured.type === 'blog' && featured.isFeatured !== 'true')
                        .map(({ id, date, title, bannerSMImageSource, alt}) => (
                            <div key={id} className="flex flex-col md:py-0 py-6">
                                ...
                                <div className="pt-2 md:w-4/5">
                                    <Link href={`/posts/${id}`}>
                                        <span>
                                            <span className='font-roboto text font-medium text-medRed.700 hover:underline truncate'>{title}</span>
                                        </span>
                                    </Link>
